...
public class Test {
	...
	public static void main(String[] args) {
		...
		results[0] = student == null ? false : student.equals(s);
		results[1] = map.containsKey(richard);
		System.out.println((Arrays.equals(expectedOutput, results) ? "pass" : "fail"));
		System.out.println("07:05:45PM".substring(0, 2));
		System.out.println("07:05:45PM".substring(3, 5));
		System.out.println("07:05:45PM".substring(6, 8));
